...
/** Local image per treatment slug (in /public). */
export const treatmentImages: Record<
  string,
  { src: string; position?: string; inset?: string }
> = {
  microblading: { src: "/microblading.webp", position: "20% 30%", inset: "-35%" },
  "powder-brows": { src: "/powder-brows.webp" },
  "combi-brows": { src: "/combi-brows.webp", position: "left center" },
  eyeliner: { src: "/eyeliner.webp", position: "center" },
